    ...
    <div className="py-8 w-full md:w-3/4 flex justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="bg-zinc-200 rounded-lg ">
          <h1 className="text-center text-xl md:text-3xl text-primary mt-10">Meet Christine</h1>
          <SwirlyLine />
          <div className="flex flex-col md:flex-row justify-center items-center md:items-start mt-10">
            <div className="bg-purple-100 p-4 md:p-10 mb-10 border-4 border-neutral rounded-3xl">
              <img src={headshot} className="w-60 h-auto rounded-3xl"></img>
              <img
                src={travel1}
                className="w-60 h-auto rounded-3xl mt-10"
              ></img>
              <img
                src={travel2}
                className="w-60 h-auto rounded-3xl mt-10"
            ...
            <div className="px-6 pb-10 w-full md:w-1/2 md:pl-10">
              <p className="text-gray-700">
                ...
                diverse range of roles within the tech industry. Her journey
                began in the 90s with Geocities web pages, sparking a
                long-standing interest in web development. Through her studies,
                she discovered a love for front-end development and enjoys
                ...
                technology and is actively seeking opportunities that leverage
                both her healthcare background and IT expertise.
                <br />
                <br />
